...
% 
%% -----Function Start--- %%
function [cScore,negLoss,integerIndexHOG,booleanIndexHOG,personLabelHOG] = identify1(Bbox,training,personIndexHOG,cMdl)
%   load training size
...
%   save image
    imwrite(queryImg,'C:\FaceRecognition\TestPics\testPic8.jpg');
