%%Prompt for name of test person
testPerson = input('Enter person being identified: ','s');
if isempty(testPerson)
    testPerson = input('Enter person being identified: ','s');
end
...
faceDatabase = imageSet('C:\FaceRecognition\pictures8','recursive');
...
[cScore,negLoss,integerIndexHOG,booleanIndexHOG,personLabelHOG] = identify1(BBOX,training,personIndexHOG,faceClassifierHOG);

%Record results of identification
recordResults(testPerson,personLabelHOG,negLoss);
